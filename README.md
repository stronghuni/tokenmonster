...
| 2 | Flamkin (유년기) | 1M | 며칠 |
| 3 | Flamon (성장기) | 5M | ~2주 |
| 4 | Blazon (성숙기) | 15M | 약 한 달 |
| 5 | Infernon (완전체) | 40M | 2~3달 |
| 6 | Phoenignis (궁극체) | 100M | **5~6달** |

> 몬스터가 먹는 토큰은 `input_tokens + output_tokens`만 카운트합니다. cache_creation / cache_read는 반복 캐시 데이터라 성장에는 반영하지 않고 비용(USD) 계산에만 씁니다. 이렇게 해야 사용자와 모델이 실제로 주고받은 양에 비례한 성장이 됩니다.
