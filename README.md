...
| 1 | 알 (Egg) | 0 | 시작 |
| 2 | Flamkin (유년기) | 3M | 며칠 |
| 3 | Flamon (성장기) | 15M | 1~2주 |
| 4 | Blazon (성숙기) | 50M | 약 한 달 |
| 5 | Infernon (완전체) | 150M | 2~3달 |
| 6 | Phoenignis (궁극체) | 400M | **5~6달** |

> 토큰은 `input + output + cache_creation`만 세고, `cache_read_input_tokens`(반복 캐시 재생)는 제외합니다. 이렇게 해야 실제로 "새로 생성된 작업량"에 가까워요.
